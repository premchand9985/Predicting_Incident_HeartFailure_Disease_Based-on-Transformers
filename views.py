...
def add_heartdetail(request):
    if request.method == "POST":
        ...
        print("Result = ",rem)
        if pred[0] == 0:
            pred = "<span style='color:green'>You are Heart failure </span>"
        elif pred[0] == 1:
            pred = "<span style='color:red'>You are Myocardial infraction , Need to Checkup.</span>"
        elif pred[0] == 2:
            pred = "<span style='color:red'>You are MDilated cardiomyopathy , Need to Checkup.</span>"
        elif pred[0] == 3:
            pred = "<span style='color:red'>You are Coronary vasaspasm , Need to Checkup.</span>"
        elif pred[0] == 4:
            pred = "<span style='color:red'>You are Atrial fibrillation, Need to Checkup.</span>"
        else:
            pred = "<span style='color:red'>You are Arrhythmia- abnormal heart rythmn, Need to Checkup.</span>"
